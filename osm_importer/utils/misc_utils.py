...
def extern_proto_declaration(options):
    ...
    if not options.noRoads:
        ...
        declaration += f'EXTERNPROTO "{PREFIX}projects/appearances/protos/CementTiles.proto"\n'
        declaration += f'EXTERNPROTO "{PREFIX}projects/objects/traffic/protos/PedestrianCrossing.proto"\n'
