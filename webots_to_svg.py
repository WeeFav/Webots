...
def compute_bounds(roads, crossroads, forests):
    """
...
def create_svg(roads, crossroads, forests, output_file="map.svg", scale=5.0, margin=50):
    """
    Export roads + crossroads to SVG.
    """
...
if __name__ == '__main__':
    ...
    roads, crossroads, forests = extract_lanes(args.input)
    create_svg(roads, crossroads, forests, output_file=args.output, scale=5)